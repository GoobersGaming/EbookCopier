...
from settings.config import UserSettings, Book
...
class BookCopierApp:
    def __init__(self, start_command=None):
        self.settings = None
        self.window = tk.Tk()
    ...
    def _setup_main_window(self):
        ...
        window_height = 300  # Taller for better spacing
    ...
    def _create_widgets(self):
        ...
        self.site_selector = ttk.Combobox(main_frame, justify="center", 
        ...
        self.page_view_selector = ttk.Combobox(main_frame, justify="center", 
        ...
        # Row 4: Start Button
        start_btn = ttk.Button(main_frame, text="Start Processing", 
    ...
    def get_book_params(self):
        ...
        logs.LOGGER.debug(f"File Path: {book.file_path}, Selected Site: {book.selected_site}, Timer: {book.timer}, Book Length: {book.book_length},"
    ...
    def _setup_logger(self):
        ...
        #log_level = [logging.WARNING, logging.CRITICAL, logging.ERROR]
        log_level = []
