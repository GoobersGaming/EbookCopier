...
"""TODO:
    Fix Being Able To Click On Canvas To Activate Canvas Without Move it."""
...
class RectangleEditor:
    def __init__(self, parent, coords=None, monitor_num=1):
        ...
        try:
            ...
            logs.LOGGER.info("Could Set Rectangle Editor window attributes")
    ...
    def absolute_to_monitor_coords_win(self, abs_x, abs_y):
        ...
        for monitor in monitors:
            ...
            if (monitor_rect[0] <= abs_x < monitor_rect[2] and
                monitor_rect[1] <= abs_y < monitor_rect[3]):
    ...
    def done(self, event=None):
        ...
        if self.rect:
            ...
            logs.LOGGER.info(f"Rectangle editor selected area: {self.rectangle_coords}")
        self.root.destroy()
        keyboard.unhook_all()
        return 
    def cancel(self, event=None):
        ...
        self.rectangle_coords = None
        logs.LOGGER.info("Rectangle editor cancelled")
        self.root.destroy()
        keyboard.unhook_all()
